...
You can customize the file upload limit by amending your [app configuration](../../create-apps).
...
The WAF enforces any file extension restriction you may have defined in your [app configuration](../../create-apps).
...
As [routes are mapped](../../define-routes) based on host names,
