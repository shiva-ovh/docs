...
slug: create-apps-create-apps-workers
section: Create-Apps
---
...
Likewise [resources defined for the application container](../../manage-resources) are inherited by every worker, unless overridden explicitly.
{{% /version/specific %}}
